...
class CustomSwitch {
    constructor() {
       this.customswitch = Selector('div.cursor-pointer.flex.items-center.gap-2.py-2.transition.duration-75.px-3.5.text-base.font-normal.leading-6.rounded-lg.bg-gray-100.hover:bg-gray-200');
